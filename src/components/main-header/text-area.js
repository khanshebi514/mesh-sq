...
export default function TextArea() {
  return (
    <div className='w-full flex items-center md:gap-5 p-5 flex-col relative text-start md:text-7xl text-2xl'>
        <div className='slide-text-background absolute top-10 md:mb-5'>
        </div>
        ...
        <div className='absolute top-[2rem] right-[2rem]  md:top-[3rem] md:right-[7rem]'> 
        <Image src={handEmoji} width={100} alt='hand image'/>
