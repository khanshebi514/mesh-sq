  ...
  return (
    <div className="w-full">
        ...
        <Row className="w-full" gutter={6}  justify={"center"} align={'top'}>
            ...
            <Col span={24} md={10}>
            <div className="flex md:flex-col justify-around items-end md:h-[300px] mr-4">
            <div>
                <h1 className="font-lg text-lg md:text-2xl">Understanding and Observing</h1>
            </div>

            <div>
                <h1 className="font-lg text-lg md:text-2xl">Specialized Solutions</h1>
            </div>

            <div>
                <h1 className="font-lg text-lg md:text-2xl">Client-Centric Approach</h1>
            </div>
            </div>
            ...
            <div className="flex flex-col justify-around items-start mr-4 h-[300px]">
